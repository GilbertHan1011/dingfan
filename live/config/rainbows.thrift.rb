...
# tell it where to be
working_directory "#{APP_DIR}/lib/thrift_http_server"

# listen on both a Unix domain socket and a TCP port,
# we use a shorter backlog for quicker failover when busy

# listen 8080, :tcp_nopush => true
listen "unix:#{APP_DIR}/tmp/sockets/rainbows.thrift.sock", :backlog => 2048
...
pid  "#{APP_DIR}/tmp/pids/rainbows.thrift.pid"
...
stderr_path "#{APP_DIR}/log/unicorn.thrift.stderr.log"
stdout_path "#{APP_DIR}/log/unicorn.thrift.stdout.log"
